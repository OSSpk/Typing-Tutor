...
2) To have a the best experience it is HIGHLY RECOMMENDED to compile the main.cpp file of the game using G++
using the command "g++ -o main.exe mygraphics.cpp myconsole.cpp main.cpp - lgdi32"

## Screenshot
![Game Play Screenshot] (../Typing-Tutor/screenshot.png)
